...
#the different bird images for animation
...
# Bird class, class that will define characteristics of a bird
class Bird():
    IMGS = BIRD_IMGS
    MAX_ROTATION = 25
    ROT_VEL = 20
    ANIMATION_TIME = 5
    #x and y represent starting positions of the bird
...
class Pipe():
    ...
    #this will randomly define pipes with randomly picked gaps
    def set_height(self):
        self.height = random.randrange(50, 450)
        self.top = self.height - self.PIPE_TOP.get_height()
        self.bottom = self.height + self.GAP
  
    #this will move the pipes 
    def move(self):
        self.x -= self.VEL 
    
    ##this will draw the pipes
    def draw(self, win):
...
#     ##it creates a population based on the loaded config file
